...
namespace Invisionware.Threading
{
	...
	public sealed class AsyncLocal<TImmutableType>
	{
		...
		public bool IsValueSet
		{
			get
			{
				return System.Runtime.Remoting.Messaging.CallContext.LogicalGetData(_slotName) != null;
			}
		}
		...
		public TImmutableType Value
		{
			get
			{
				var ret = System.Runtime.Remoting.Messaging.CallContext.LogicalGetData(_slotName);
				if (ret == null)
